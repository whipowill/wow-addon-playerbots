...
function CreateBotRoster()
    ...
    for i = 1,10 do
        ...
        item.text:SetFont("Fonts/ZYKai_T.TTF", 11, "OUTLINE")
        ...
        CreateToolBar(item, -18, "quickbar"..i, {
            ["login"] = {
                ...
                command = {[0] = ""},
                strategy = "",
                tooltip = L["Bring bot online"],
                index = 0
            },
            ["logout"] = {
                icon = "logout",
                command = {[0] = ""},
                tooltip = L["Logout bot"],
                strategy = "",
                index = 0
            },
            ["invite"] = {
                icon = "invite",
                command = {[0] = ""},
                tooltip = L["Invite to your group"],
                strategy = "",
                index = 1
            },
            ["leave"] = {
    ...
    CreateToolBar(frame, 0, "quickbar", {
        ["login_all"] = {
            ...
            command = {[0] = ""},
            strategy = "",
            tooltip = L["Bring all bots online"],
            index = 0
        },
        ["logout_all"] = {
            icon = "logout",
            command = {[0] = ""},
            tooltip = L["Logout all bots"],
            strategy = "",
            index = 1
        },
        ["invite_all"] = {
            icon = "invite",
            command = {[0] = ""},
            tooltip = L["Invite all bots to your group"],
            strategy = "",
            index = 2
        },
        ["leave_all"] = {
            icon = "leave",
            command = {[0] = ""},
            tooltip = L["Remove all bots from group"],
            strategy = "",
            index = 3
        }
    }, 5, 0, false)
...
function CreateSelectedBotPanel()
    ...
    frame.header.text:SetFont("Fonts/ZYKai_T.TTF", 11, "OUTLINE")
    ...
    CreateToolBar(frame, -y, "actions", {
        ...
        ["loot_normal"] = {
            ...
            command = {[0] = "ll normal,?"},
            ll = "normal",
            tooltip = L["Loot (if looting) normal"],
            index = 2
        },
        ["loot_all"] = {
            icon = "ll_all",
            command = {[0] = "ll all,?"},
            ll = "all",
            tooltip = L["Loot (if looting) everything"],
            index = 3
        },
        ["loot_de"] = {
            icon = "ll_disenchant",
            ...
            ll = "disenchant",
            tooltip = L["Loot (if looting) disenchant"],
            index = 4
        },
        ["loot_gray"] = {
            icon = "ll_gray",
            command = {[0] = "ll gray,?"},
            ll = "gray",
            tooltip = L["Loot (if looting) gray"],
            index = 5
        },
        ["loot_skill"] = {
            icon = "food",
            command = {[0] = "ll skill,?"},
            ll = "skill",
            tooltip = L["Loot (if looting) profession"],
            index = 6
        },
        ["reset_actions"] = {
            icon = "passive",
    ...
    CreateToolBar(frame, -y, "attack_type", {
        ["tank_aoe"] = {
            ...
            strategy = "tank aoe",
            tooltip = L["Play as primary tank"],
            index = 0
        },
        ["tank_assist"] = {
            icon = "tank_assist",
            ...
            tooltip = L["Play as secondary tank"],
            index = 1
        },
        ["dps_assist"] = {
            icon = "dps_assist",
    ...
    CreateToolBar(frame, -y, "rti", {
        ["attack_rti"] = {
            ...
            strategy = "attack rti",
            tooltip = L["Attack enemy with assigned mark",
            index = 0
        },
        ["rti_skull"] = {
            icon = "rti_skull",
        ...
        ["rti_triangle"] = {
            ...
            rti = "triangle",
            tooltip = L["Assign triangle mark"],
            index = 6
        },
        ["rti_diamond"] = {
            icon = "rti_diamond",
    ...
    CreateToolBar(frame, -y, "generic", {
        ["potions"] = {
            ...
            strategy = "potions",
            tooltip = L["Use health and mana potions"],
            index = 0
        },
        ["food"] = {
            icon = "food",
        ...
        ["cast_time"] = {
            ...
            strategy = "cast time",
            tooltip = L["Cast long spells cautiously"],
            index = 2
        },
        ["conserve_mana"] = {
            icon = "conserve_mana",
        ...
        ["attack_weak"] = {
            ...
            tooltip = L["Attack weak enemy first"],
            index = 5
        },
        ["threat"] = {
            icon = "threat",
            command = {[0] = "co +threat,?"},
            strategy = "threat",
            tooltip = L["Keep threat level low"],
            index = 6
        },
        ["custom_say"] = {
            icon = "whisper",
    ...
    CreateToolBar(frame, -y, "CLASS_MAGE", {
        ...
        ["fire_aoe"] = {
            ...
            strategy = "fire aoe",
            tooltip = L["Use fire AOE abilities"],
            index = 2
        },
        ["frost"] = {
            icon = "frost",
        ...
        ["frost_aoe"] = {
            ...
            strategy = "frost aoe",
            tooltip = L["Use frost AOE abilities"],
            index = 4
        },
        ["bmana"] = {
            icon = "bmana",
    ...
    CreateToolBar(frame, -y, "CLASS_PALADIN", {
        ...
        ["bthreat"] = {
            ...
            strategy = "bthreat",
            tooltip = L["Buff threat generation"],
            index = 7
        },
        ["reset_paladin"] = {
            icon = "passive",
    ...
    CreateToolBar(frame, -y, "CLASS_PRIEST", {
        ...
        ["shadow_aoe"] = {
            ...
            strategy = "shadow aoe",
            tooltip = L["Use shadow AOE abilities"],
            index = 3
        },
        ["shadow_debuff"] = {
            icon = "shadow_debuff",
    ...
    CreateToolBar(frame, -y, "CLASS_SHAMAN", {
        ...
        ["caster_aoe"] = {
            ...
            strategy = "caster aoe",
            tooltip = L["Use caster AOE abilities"],
            index = 1
        },
        ["heal"] = {
            icon = "heal",
...
print("PlayerBots插件已加载,输入 /bot 打开界面");